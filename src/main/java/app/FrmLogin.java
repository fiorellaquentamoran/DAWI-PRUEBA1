...
public class FrmLogin extends JFrame {
	...
	void registrar() {
		...
		TypedQuery<Usuario> consulta= em.createQuery("select c from Usuario c where c.usuario= :xusu and c.clave= :xclave", Usuario.class);
		
		//paraetros 
		consulta.setParameter("xusu", correo);
		consulta.setParameter("xclave", clave);
	   ...
	   Usuario u =	null;
		...
		try {
			...
			u=consulta.getSingleResult();
				...
				JOptionPane.showMessageDialog(null, "accedió");
			
	
				System.out.println("accedio"+u);
